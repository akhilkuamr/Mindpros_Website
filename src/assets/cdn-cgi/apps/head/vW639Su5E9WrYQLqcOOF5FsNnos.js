...
CloudflareApps.siteId = "6eba05234ec703fd0d966e63b461df27";
...
CloudflareApps.installs["mpNCQqxqlQmD"] = {
    appId: "nGAnsTeiPCQx",
    scope: {}
};;
CloudflareApps.installs["mpNCQqxqlQmD"].options = {
    "subdomain_tracker_ids": [{
        "subdomain": "",
        "tracker_id": ""
    }],
    "tracker_id": "UA-197491637-1"
};;
CloudflareApps.installs["mpNCQqxqlQmD"].product = {
    "id": "google-analytics-free"
};
(function() {
    var script = document.createElement('script');
    script.src = '/cdn-cgi/apps/body/-i5MrC5vYSJAVhXdFhnaj8AOEWQ.js';
