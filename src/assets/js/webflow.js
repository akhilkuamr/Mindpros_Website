...
! function(t) {
    ...
    n(102), n(16), n(105), n(258), n(259), n(260), n(261), n(266), n(267), t.exports = n(268)
}, function(t, e, n) {
    "use strict";
    var r = n(4);
            ...
            case g.RENDER_TRANSFORM:
                return function(t, e, n, r, i) {
                    var o = j.map(function(t) {
                        ...
                        a = i.setStyle;
                    U(t, y.TRANSFORM_PREFIXED, i), a(t, y.TRANSFORM_PREFIXED, o), u = r, c = n, s = u.actionTypeId, f = c.xValue, l = c.yValue, d = c.zValue, (s === T.TRANSFORM_MOVE && void 0 !== d || s === T.TRANSFORM_SCALE && void 0 !== d || s === T.TRANSFORM_ROTATE && (void 0 !== f || void 0 !== l)) && a(t, y.TRANSFORM_STYLE_PREFIXED, g.PRESERVE_3D);
                    var u, c, s, f, l, d
                }(t, e, n, i, a);
            case g.RENDER_STYLE:
                    ...
                    switch (u) {
                        ...
                        case T.STYLE_TEXT_COLOR:
                            var _ = O[u],
                                ...
                                A = n.aValue;
                            U(t, _, o), a(t, _, A >= 1 ? "rgb(".concat(I, ",").concat(y, ",").concat(m, ")") : "rgba(".concat(I, ",").concat(y, ",").concat(m, ",").concat(A, ")"));
                            break;
                        default:
                            var S = c.unit,
                                R = void 0 === S ? "" : S;
        ...
        y = function(t, e) {
            ...
            if (h && !_)
                for (var D = 0, P = a.length; D < P; D++) {
                    ...
                    for (var F = (O - I) / T, G = h.config.easing, j = v(G, F, f), V = 0, X = a.length; V < X; V++) {
                        var U = a[V],
                            k = g(s, U, h.config),
                            W = (g(s, U, _.config) - k) * j + k;
                        x[U] = W
                    }
            return (0, i.merge)(t, {
                position: O,
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "selector": ".tab-link",
                "originalId": "5dff645ee5da779dfc7d4d61|18b1f769-114b-3ee3-c3e1-cacdb1727c52",
                "appliesTo": "CLASS"
            },
            "config": {
                "loop": false,
        ...
        "e-9": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5dff645ee5da779dfc7d4d61|88bf3867-fe44-a86f-7147-863c15a4b24b"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-11": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5dff645ee5da779dfc7d4d61|97b7dc67-67ee-1b04-ff98-373a905e9720"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-13": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5dff645ee5da779dfc7d4d61|319d105f-5566-33a2-c666-845408050d3d"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-15": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5dff645ee5da779dfc7d4d61|c336cfc4-0f65-70b0-7035-9f04dc3e0cf2"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
    ...
    "actionLists": {
        "a": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "easing": "",
                        "duration": 500,
                        "globalSwatchId": "5fe106c1",
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".fa-normal.tab-icon",
                            "selectorGuids": ["a8424f1e-f850-1654-61e0-ebcc2c178d79", "0930283e-298d-a0f7-c045-70fc2214ddd4"]
                        },
                        "rValue": 185,
                        "gValue": 186,
                        "bValue": 218,
                    ...
                    "config": {
                        ...
                        "easing": "",
                        "duration": 500,
                        "globalSwatchId": "992eaf10",
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".service-name",
                            "selectorGuids": ["3beb63d8-fc3a-1766-1314-a85d832c921e"]
                        },
                        "rValue": 0,
                        "gValue": 0,
                        "bValue": 0,
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".service-underline",
                            "selectorGuids": ["0debd866-cc62-d943-9a02-12e80025a92c"]
                        },
                        "xValue": 0,
                        "locked": false
                    }
            ...
            "createdOn": 1577177080456,
            "useFirstGroupAsInitialState": true
        },
        "a-2": {
            "id": "a-2",
            "title": "Services Tab Out of View",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
                    "actionTypeId": "STYLE_TEXT_COLOR",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "5dff645ee5da779dfc7d4d61|d2827eb3-c7c2-d44a-7881-0e2ed1bb8d84"
                        },
                        "heightValue": 80,
                        "widthUnit": "PX",
                        "heightUnit": "PX"
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".fa-normal.plus-sign",
                            "selectorGuids": ["a8424f1e-f850-1654-61e0-ebcc2c178d79", "3af5a2e2-0e29-5977-5871-8d4bcdb1a831"]
                        },
                        "zValue": 135,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
